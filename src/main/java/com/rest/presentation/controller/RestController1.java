...
public class RestController1 {
    ...
    public
    @ResponseBody
    ResponseEntity<ResponseDTO> postUserAndResponseAsJason(@RequestBody RequestDTO requestDTO, @PathVariable String id) {
    ...
    public
    @ResponseBody
    ResponseEntity<ResponseDTO> getUserAndResponseAsJason(@PathVariable String id) {
